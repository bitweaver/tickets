<?php
// $Header: /cvsroot/bitweaver/_bit_tickets/Attic/list_ticketss.php,v 1.1 2008/11/19 23:15:13 pppspoonman Exp $
...
if( isset( $_REQUEST["submit_mult"] ) && isset( $_REQUEST["checked"] ) && $_REQUEST["submit_mult"] == "remove_ticketss" ) {
	...
	if( !empty( $_REQUEST['cancel'] ) ) {
		...
		$gBitSystem->confirmDialog( $formHash, 
			array(
				'warning' => tra('Are you sure you want to delete ').count( $_REQUEST["checked"] ).' ticketss?',
